...
console.log(createMenuItem("eggs", 8, "lunch"));   
console.log(createMenuItem("hamburger", 10, "drinks"));
...
const burger = {
  ...
  { 
    if(subject === 'teacher'|| subject === 'student')
    {
...
console.log(addReview(reviews,"june", 1,`the food here is not great,I would not recommend this restaurant`));
...
function getLastReview(array) 
{
      //  array.pop();
   array.unshift();
    // `${array.name} gave the restaurant a ${array.rating} star review, and their feedback was:${array.feedback} `;
